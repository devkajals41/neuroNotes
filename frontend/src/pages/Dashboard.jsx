...
// 1. Uncomment the LOCAL URL and comment the PRODUCTION URL below.
// 2. Start the backend server (npm run dev in backend directory).
// ==========================================
// const BACKEND_URL = "http://localhost:5000"; // LOCAL URL
const BACKEND_URL = "https://neuronotes-backend-afri.onrender.com"; // PRODUCTION URL
...
function Dashboard() {
  ...
  const handleKnowledgeGraph = async (noteContent) => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.post(
        `${BACKEND_URL}/api/ai/knowledge-graph`,
        {
          content: noteContent,
        },
        {
  ...
  return (
    <div className="dashboard">
      <div className="sidebar">
        <div className="logo">
          <img src={logo} alt="NeuroNotes" className="logo-img" />
        ...
        {filteredNotes.map((note) => (
          <div
            key={note._id}
            className={
              selectedNote?._id === note._id ? "note-card active" : "note-card"
            }
            onClick={() => {
      ...
      <div className="main">
        ...
        <div className="welcome-banner">
          <div className="welcome-card-v2">
            ...
            <p>
              Turn notes into summaries, flashcards, concept maps and knowledge
              graphs.
            </p>
          </div>
          ...
          <>
            <div className="section">
              ...
              <div className="tabs">
                <button
                  className={
                    activeTab === "summary" ? "tab-btn active" : "tab-btn"
                  }
                ...
                <button
                  className={
                    activeTab === "flashcards" ? "tab-btn active" : "tab-btn"
                  }
                ...
                <button
                  className={
                    activeTab === "concept" ? "tab-btn active" : "tab-btn"
                  }
                ...
                <button
                  className={
                    activeTab === "graph" ? "tab-btn active" : "tab-btn"
                  }
                ...
                <button
                  className={
                    activeTab === "dictionary" ? "tab-btn active" : "tab-btn"
                  }
              ...
              <div className="section">
                {loading && (
                  <div className="loading-box">Generating AI Response...</div>
                )}
                ...
                {activeTab === "dictionary" && dictionaryResult && (
                  <>
                    <h2>Dictionary</h2>
                    ...
                    <div className="dictionary-card">
                      ...
                      <div className="dictionary-content">
                        {dictionaryResult?.split("\n").map((line, index) => {
                          if (line.startsWith("Word:")) {
                            return (
                              <h3 key={index} className="dict-word">
                                {line.replace("Word:", "")}
                              </h3>
                            );
                          }
                          ...
                          if (line.startsWith("Meaning:")) {
                            return (
                              <p key={index} className="dict-heading">
                                Meaning:
                              </p>
                            );
                          }
                          ...
                          return (
                            <p key={index} className="dict-text">
                              {line}
                            </p>
                          );
                        })}
